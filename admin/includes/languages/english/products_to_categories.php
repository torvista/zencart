...
define('TEXT_INFO_PRODUCTS_TO_CATEGORIES_LINKER_INTRO', 'This product is currently linked to the categories selected below (you may change the number of columns displayed <a target="_blank" href="configuration.php?&amp;gID=3&amp;cID=93&amp;action=edit">here</a>).<br />To add/remove links, select/deselect the checkboxes as required and then click on the ' . BUTTON_UPDATE_CATEGORY_LINKS . ' button. <br /><br />Note that additional product/category actions are available using the Global Tools below.');
//Z157? define('TEXT_INFO_PRODUCTS_TO_CATEGORIES_LINKER_INTRO', 'This product is currently linked to the categories selected below (you may change the number of columns displayed <a href="' . FILENAME_DEFAULT . '.php?cmd=configuration&amp;gID=3&amp;cID=106&amp;action=edit">here</a>).<br />To add/remove links, select/deselect the checkboxes as required and then click on the ' . BUTTON_UPDATE_CATEGORY_LINKS . ' button. <br /><br />Note that additional product/category actions are available using the Global Tools below.');
