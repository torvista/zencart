...
define('TEXT_INFO_PRODUCTS_TO_CATEGORIES_LINKER_INTRO', 'This product is currently linked to the categories selected below (you may change the number of columns displayed <a target="_blank" href="configuration.php?&amp;gID=3">here</a>).<br />To add/remove links, select/deselect the checkboxes as required and then click on the ' . BUTTON_UPDATE_CATEGORY_LINKS . ' button. <br /><br />Note that additional product/category actions are available using the Global Tools below.');
...
define('TEXT_PRODUCTS_ID_NOT_REQUIRED', 'Note: A Product does not need to be selected to use all these tools. However, selecting a Product above will display the Categories and their ID numbers (on hover).');
